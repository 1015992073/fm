					...
					<tbody>
						<?php foreach ($data as $item) : ?>
							<tr>
								...
								<?php endforeach ?>
								<td>
									<a class="" href="<?= $the_controller_url ?>/edit/<?= $item[$primary_key] ?>" role="button"><?= lang("edit") ?></a>
									<a class="" href="<?= $admin_home_url ?>/field/list/<?= $item[$primary_key] ?>" role="button"><?= lang("edit") .  lang("field") ?></a>
									<a class="" href="<?= $the_controller_url ?>/del/<?= $item[$primary_key] ?>" role="button"><?= lang("del") ?></a>
								</td>
							</tr>
						<?php endforeach ?>
